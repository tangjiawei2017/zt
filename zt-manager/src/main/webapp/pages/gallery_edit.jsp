					...
					<form class="layui-form" action="" id="form">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="name" class="layui-input"
									value="${gallery.name}" data-rule='{"required":true}'>
							</div>
						...
						<div class="layui-form-item img-div2">
							...
							<div class="layui-input-inline image">
								<button type="button" class="layui-btn layui-btn-normal"
									id="logo2">选择</button>
								<c:if test="${gallery.mpath!=null}">
									<section class="up-section logo-img2">
										<span class="up-span"></span> <img class="close-upimg"
											src="${ctx}/images/del.png"> <img class="up-img"
											src="${gallery.mpath}" data-src="${gallery.mpath}" />
									</section>
								</c:if>
							</div>
						</div>
						<div class="layui-form-item layui-form-text">
						    ...
						    <div class="layui-input-block">
						      <textarea name="content" placeholder="请输入内容" class="layui-textarea">${gallery.content}</textarea>
						    </div>
						</div>
					</form>
				</c:when>
